...
import { Calendar, ArrowRight, User, Eye, Tag } from 'lucide-react';
...
const ProjectDetails = () => {
  ...
  const projectsData = {
    "fintech-app": {
      ...
      coverImage: "https://images.unsplash.com/photo-1531297484001-80022131f5a1?auto=format&fit=crop&q=80&w=2400",
      description: "A comprehensive finance dashboard designed for BankTech Solutions to help their customers visualize spending patterns, track investments, and manage budgets in real-time.",
      challenge: "The client needed a dashboard that could present complex financial data in an intuitive, easy-to-understand way. The dashboard needed to accommodate various user types, from casual consumers to financial advisors, while maintaining high security standards.",
      solution: "I designed a modular dashboard system with customizable widgets that allows users to personalize their experience based on their needs. The interface uses clear visual hierarchies and data visualizations to make complex information accessible at a glance.",
      process: [
      ...
      results: "The new dashboard increased user engagement by 45% and reduced support tickets related to interface confusion by 60%. The client reported higher customer satisfaction scores and increased usage of advanced financial planning features.",
      galleryImages: [
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=2400",
        "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?auto=format&fit=crop&q=80&w=2400",
        "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=2400",
        "https://images.unsplash.com/photo-1551269901-5c5e14c25df7?auto=format&fit=crop&q=80&w=2400"
      ],
    ...
    "mobile-app": {
      ...
      coverImage: "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?auto=format&fit=crop&q=80&w=2400",
      description: "A cutting-edge mobile application designed for TechStart Inc. to streamline their customer service processes and provide a seamless user experience for their growing user base.",
      challenge: "TechStart needed an app that would simplify their complex customer service workflow while providing a modern, intuitive interface for users who range from tech-savvy young adults to older individuals with limited technological experience.",
      solution: "I created a clean, minimalist design with clear navigation paths and accessibility features. The app incorporates subtle animations to guide users through processes and uses a consistent visual language to create familiarity.",
      process: [
      ...
      results: "The redesigned app saw a 35% increase in daily active users and a 28% decrease in customer service calls. App Store ratings improved from 3.6 to 4.8 stars, with users specifically praising the intuitive interface and ease of use.",
      galleryImages: [
  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9]">
      ...
      <section className="pt-32 pb-16 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-wrap items-center justify-between mb-6">
            <span className="px-4 py-1 rounded-full bg-[var(--color-secondary)]/10 text-[var(--color-secondary)] text-sm font-medium">
              {project.category}
            </span>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Challenge */}
            <div>
              <h2 className="text-3xl font-bold mb-6 theme-color-primary">The Challenge</h2>
              <p className="text-muted-foreground">{project.challenge}</p>
            </div>
            
            {/* Solution */}
            <div>
              <h2 className="text-3xl font-bold mb-6 theme-color-primary">The Solution</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold mb-10 text-center">Design Process</h2>
          ...
          <div className="related-slider">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {getRelatedProjects().map((relatedProject, index) => (
                <Link to={`/projects/${relatedProject.id}`} key={index} className="group">
                    ...
                    <div className="p-6">
                      <div className="flex flex-wrap gap-2 mb-3">
                        {relatedProject.tags.slice(0, 2).map((tag, idx) => (
                          <span key={idx} className="text-xs bg-[var(--color-secondary)]/10 text-[var(--color-secondary)] px-2 py-1 rounded-full font-medium">
                            {tag}
                          </span>
                        ))}
                      </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <p className="max-w-2xl mx-auto mb-8 text-muted-foreground">
            Let's collaborate to create an amazing digital experience that meets your business goals and delights your users.
          </p>
          <Link 
            to="/contact" 
