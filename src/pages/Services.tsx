...
import { ArrowRight, Layout, Smartphone, Globe, Brush, Palette, PenTool, Type, PackageOpen, ImagePlus } from 'lucide-react';

const Services = () => {
  const services = [
    {
      id: "logo-design",
      icon: <span className="inline-block w-10 h-10 rounded-xl bg-blue-100 text-blue-800 flex items-center justify-center text-2xl">🎨</span>,
      title: 'Logo Design',
      description: 'Creating unique and memorable logos that stand out in a crowded marketplace.',
    ...
    },
    {
      ...
      icon: <span className="inline-block w-10 h-10 rounded-xl bg-yellow-100 text-yellow-700 flex items-center justify-center text-2xl">📇</span>,
      title: 'Business Card Design',
      description: 'Designing impactful business cards that leave a lasting impression.',
      features: [
        "Unique layouts",
    ...
    },
    {
      ...
      icon: <span className="inline-block w-10 h-10 rounded-xl bg-green-100 text-green-700 flex items-center justify-center text-2xl">🖨️</span>,
    ...
    },
    {
      ...
      icon: <span className="inline-block w-10 h-10 rounded-xl bg-pink-100 text-pink-700 flex items-center justify-center text-2xl">✏️</span>,
    ...
    },
    {
      ...
      icon: <span className="inline-block w-10 h-10 rounded-xl bg-orange-100 text-orange-700 flex items-center justify-center text-2xl">✔</span>,
    ...
    {
      id: "banner-design",
      icon: <span className="inline-block w-10 h-10 rounded-xl bg-purple-100 text-purple-700 flex items-center justify-center text-2xl">✍</span>,
      title: "Banner Design",
      description:
    ...
    ,
    {
      id: "brochures-posters-flyer-design",
      icon: <span className="inline-block w-10 h-10 rounded-xl bg-purple-100 text-purple-700 flex items-center justify-center text-2xl">✍</span>,
    ...
    {
      id: "image-editing",
      icon: <span className="inline-block w-10 h-10 rounded-xl bg-purple-100 text-purple-700 flex items-center justify-center text-2xl">🖨️</span>,
      title: "Image Editing",
      description:
    ...
    <div className="min-h-screen bg-[#f9f9f9]">
      ...
      <section className="pt-32 pb-16 bg-white">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">My <span className="theme-color-secondary">Services</span></h1>
          <p className="text-muted-foreground max-w-2xl mx-auto mb-10">
            With over 18 years of experience in design, I offer a comprehensive range of services to help brands create meaningful digital experiences.
          </p>
        </div>
      </section>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <Link to={`/services/${service.id}`} className="block mb-2">
                  <h3 className="text-xl font-bold mb-1 hover:theme-color-secondary transition-colors">{service.title}</h3>
                </Link>
                <p className="text-black-soft/70 mb-4">{service.description}</p>
                <div className="mb-5 w-full">
                  <h4 className="text-xs font-semibold mb-1 text-black-soft/50">KEY FEATURES</h4>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to Start Your <span className="theme-color-secondary">Project</span>?</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
            Let's collaborate to create something amazing together. Contact me today to discuss your next design project.
          </p>
          <Link
            to="/contact"
