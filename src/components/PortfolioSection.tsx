...
const PortfolioSection = () => {
  const portfolioItems = [
    ...
    },
    {
      ...
      category: "Dashboard",
      tags: ["Enterprise", "CRM"],
      image: "https://images.unsplash.com/photo-1505373877841-8d25f7d46678?auto=format&fit=crop&q=80&w=2400"
    },
    {
      id: "food-delivery",
    ...
    <section id="portfolio" className="py-24 bg-muted">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex justify-between items-center flex-wrap mb-12">
          <h2 className="text-3xl md:text-4xl font-bold theme-color-primary">My Latest Projects</h2>
          <EmotionalButton 
            href="/projects" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {portfolioItems.slice(0, 6).map((item) => (
            <div key={item.id} className="portfolio-card bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500 hover:-translate-y-2 group animate-fade-in">
